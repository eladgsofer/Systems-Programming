...
public:
    ...
    Manager();
    Manager(char *firstName, char *lastName, double tSeniority,  double aSeniority, \
        const vector<string> &teacherCourses, int coursesAmount, const string &officeLocation);
    virtual ~Manager();
