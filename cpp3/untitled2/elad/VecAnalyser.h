...
#ifndef CPP_3_VECANALYSER_H
#define CPP_3_VECANALYSER_H
#endif //CPP_3_VECANALYSER_H
...
public:
    ...
    bool isIndexValid(int index) {
        return (index >= 0 && index < this->currentVector.size());
    }
    ...
    void printMax() {
        ...
        for (int i = 0; i < this->currentVector.size(); i++) {
            if (this->type == 'W') {
